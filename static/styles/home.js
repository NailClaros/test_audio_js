    ...
    const recordOne = async () => {
        ...
        mediaRecorder.onstop = async () => {
            ...
            if (responseData.endLoop === true) {
                        ...
                        const baseUrl = "/found"; // Use Flask to generate the base URL

                        // Construct the URL with query parameters
                        const redirectUrl = `${baseUrl}?sn=${encodeURIComponent(responseData.sn)}&sa=${encodeURIComponent(responseData.sa)}&la=${encodeURIComponent(responseData.la)}&ly=${encodeURIComponent(responseData.ly)}&ca=${encodeURIComponent(responseData.ca)}`;
